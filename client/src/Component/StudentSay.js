    ...
    <>
      ...
      {/* <div className='student_card' style={{display:"flex",marginRight:"30px",border:"2px solid red"}}> */}
        ...
        <Card className='student_cards' sx={{backgroundColor: "#FFFFF" ,border:"2px solid whitesmoke" }}>
          <CardContent>
            <Typography sx={{ color: '#343b6d',fontSize: '20px',lineHeight: '1.6' }} color="text.secondary" gutterBottom>
            বাগ রেজিস্ট্যান্সের SQA লাইভ কোর্সে যতটুকু এক্সপেক্টেশন নিয়ে এসেছি, তার থেকে অনেক বেশি কিছু পেয়েছি। সম্পূর্ণ নতুন একটি জিনিস কিভাবে শিখবো সেটা নিয়ে অনেক দ্বিধাদ্বন্দতে ছিলাম, কিন্তু কোর্স শেষ করার পর মনে হয়েছে অনেক কিছু নতুন আঙ্গিকে জানতে পেরেছি । সবচেয়ে ভালো লেগেছে উদাহরণ ও গল্পগুলো, যা আমাদের জীবনের সাথে পুরোপুরি ভাবে বাস্তবিক শিক্ষা দেয়। বহুব্রীহি কে ধন্যবাদ জানাই কোর্সটি এত প্রাণবন্তভাবে সাজানোর জন্য।
            </Typography>
          </CardContent>
          <CardActions>
            <Avatar src={student} />
